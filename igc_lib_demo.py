...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        sys.exit(1)
    """
    #input_file = sys.argv[1] orginal
    input_file = "C:/Users/bethge-adm/Documents/igc_lib-master/igc_lib-master/B.igc"
    #input_file = "C:/Users/bethge-adm/Documents/fredmaster/Tracks/2018-08-11-XCT-PBE-01.igc"
    task_file = "C:/Users/bethge-adm/Documents/igc_lib-master/igc_lib-master/DISENTIS.Lkt"
    #task_file = "C:/Users/bethge-adm/Documents/igc_lib-master/igc_lib-master/testfiles/napret.lkt"
    if len(sys.argv) > 2:
